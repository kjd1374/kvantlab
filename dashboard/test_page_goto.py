...
async def run():
    async with async_playwright() as p:
        ...
        url = "https://www.oliveyoung.co.kr/store/main/getBestList.do?dispCatNo=10000010009&fltDispCatNo=10000010009"
        ...
        # Test Nail
        url = "https://www.oliveyoung.co.kr/store/main/getBestList.do?dispCatNo=10000010012&fltDispCatNo=10000010012"
        print(f"\nNavigating to {url}")
        await page.goto(url, wait_until="domcontentloaded")
        await asyncio.sleep(4)
