...
const FALLBACK_STRINGS = {
    ...
    'tutorial.subtitle': { 'ko': 'K-Vant를 활용해 글로벌 매출을 극대화하는 4단계 비법', 'en': '4-step guide to maximizing global sales with K-Vant' },
    'tutorial.step1_title': { 'ko': 'Always-Fresh Rankings', 'en': 'Always-Fresh Rankings' },
    'tutorial.step1_desc': { 'ko': 'Real-time rankings from Olive Young, Musinsa & Naver Shopping — updated daily so you always see what\'s selling now. More platforms coming soon. Your sourcing intel keeps growing.', 'en': 'Real-time rankings from Olive Young, Musinsa & Naver Shopping — updated daily so you always see what\'s selling now. More platforms coming soon. Your sourcing intel keeps growing.' },
    'tutorial.step2_title': { 'ko': 'Request Any Product, Instantly', 'en': 'Request Any Product, Instantly' },
    'tutorial.step2_desc': { 'ko': 'Found something? Hit the cart button to request wholesale pricing directly from Korea — no middleman needed. Don\'t see it in the rankings? You can still request it manually. If it exists in Korea, we\'ll find it.', 'en': 'Found something? Hit the cart button to request wholesale pricing directly from Korea — no middleman needed. Don\'t see it in the rankings? You can still request it manually. If it exists in Korea, we\'ll find it.' },
    'tutorial.step3_title': { 'ko': 'Trend Analysis You Can Trust', 'en': 'Trend Analysis You Can Trust' },
    'tutorial.step3_desc': { 'ko': 'K-Vant tracks Korean product trends locally and globally. Our AI analyzes thousands of real buyer reviews — so you know what\'s selling and why. No guesswork. Just clear data, analyzed for you.', 'en': 'K-Vant tracks Korean product trends locally and globally. Our AI analyzes thousands of real buyer reviews — so you know what\'s selling and why. No guesswork. Just clear data, analyzed for you.' },
    'tutorial.step4_title': { 'ko': 'Your Edge Starts Now. Free for 14 Days.', 'en': 'Your Edge Starts Now. Free for 14 Days.' },
    'tutorial.step4_desc': { 'ko': 'Your competitors are sourcing blind. You don\'t have to. Try K-Vant free for 14 days and find what\'s trending in Korea before it hits your market.', 'en': 'Your competitors are sourcing blind. You don\'t have to. Try K-Vant free for 14 days and find what\'s trending in Korea before it hits your market.' },
