...
const FALLBACK_STRINGS = {
    ...
    'platforms.ssg': { ko: '신세계 (SSG)', en: 'Shinsegae (SSG)' },
    'platforms.k_trend': { ko: '코리아 트렌드', en: 'Korea Trends' },
    'billing.history.no_data': { ko: '결제 내역이 없습니다.', en: 'No billing history.' },
    
    // --- Margin Calculator ---
    'calc.title': { ko: '🧮 B2B 마진 시뮬레이터', en: '🧮 B2B Margin Simulator' },
    'calc.cost_price': { ko: '1. 매입 원가', en: '1. Supply Cost (KRW)' },
    'calc.cost_sub': { ko: '(자동 연동)', en: '(Auto-synced)' },
    'calc.sell_price': { ko: '2. 현지 예상 판매가', en: '2. Expected Local Price' },
    'calc.sell_sub': { ko: '(직접 입력)', en: '(Your input)' },
    'calc.exchange_rate': { ko: '적용 환율', en: 'FX Rate' },
    'calc.exchange_rate_sub': { ko: '(수정 가능)', en: '(Editable)' },
    'calc.shipping': { ko: '기본 배송/포장비', en: 'Shipping/Pack Cost' },
    'calc.platform_fee': { ko: '플랫폼 수수료(%)', en: 'Platform Fee(%)' },
    'calc.profit': { ko: '✨ 예상 순이익 (마진율)', en: '✨ Est. Profit (Margin)' },
    'calc.sourcing_btn': { ko: '🚀 이 제품 바로 소싱하기', en: '🚀 Source This Item' },
    'calc.watchlist_btn': { ko: '관심상품 추가', en: 'Add to Watchlist' },
    'calc.watchlist_btn_active': { ko: '관심상품 취소', en: 'Remove Watchlist' },
    'platforms.coming_soon': { ko: '+ 추가예정', en: '+ Coming Soon' },
